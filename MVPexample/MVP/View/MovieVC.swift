...
//  mansTV
//
//  Created by Matiss Mamedovs on 12/05/2018.
...
class MovieVC: UIViewController {
    ...
    //VARIABLES
    let moviePresenter = MoviePresenter(dataHelper: DataHelper())
    ...
    override func viewDidLoad() {
        ...
        if let categoryID = self.categoryID {
            moviePresenter.getMovie(movieID: movieID, categoryID: categoryID)

        } else {
            moviePresenter.getMovie(movieID: movieID)
        }
...
extension MovieVC : MovieView {
    ...
    func showSwitchSeasonAlertView(seasons: [Int]) {
        ...
        for season in seasons {
            let action = UIAlertAction(title: self.seasonLabel(season), style: .default , handler: {
                ...
                self.moviePresenter.switchSeason(season)
            })
    ...
    func showSubtitlesAlertView(sender: UITapGestureRecognizer, optionMessage: String, defaultTitle: String, subtitles: [String]) {
        ...
        let defaultAction = UIAlertAction(title: defaultTitle, style: .default, handler: {
            ...
            self.moviePresenter.removeSubtitles()
            self.resizeBottomLabel(sender: sender.view!, text: "Subtitri (-)")
            self.moviePresenter.subtitleTrackChanged()
        })
        ...
        for subtitle in subtitles {
            let langAction = UIAlertAction(title: subtitle, style: .default, handler: {
                ...
                self.moviePresenter.selectSubtitle(selectedSubtitle: subtitle)
    ...
    func showLanguagesAlertView(sender: UITapGestureRecognizer, optionMessage: String, languages: [String]) {
        ...
        for language in languages {
            let langAction = UIAlertAction(title: language, style: .default, handler: {
                ...
                self.moviePresenter.selectLanguage(selectedLanguage: language)
                self.resizeBottomLabel(sender: sender.view!, text: "Valoda (\(language))")
                if self.playerController != nil {
                    self.moviePresenter.languageSelectionChanged(currentTime: (self.player?.currentItem?.currentTime())!)
                }
            })
    ...
    func removePLayer() -> Void {
        if(playerController != nil)
        {
            ...
            moviePresenter.saveContinueWatching(currentItem: (player?.currentItem)!)
...
extension MovieVC {
    ...
    fileprivate func addTopViews() {
        ...
        self.mainImageView.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(moviePresenter.mainImageAction)))
        ...
        backView.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(moviePresenter.backAction)))
        ...
        self.backImageView.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(moviePresenter.backAction)))
    ...
    func addActionButtons() {
        ...
        likeButton.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(moviePresenter.likeButtonAction)))
        ...
        dislikeButton.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(moviePresenter.dislikeButtonAction)))
        ...
        watchlaterButton.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(moviePresenter.watchLaterButtonAction)))
        ...
        subsView!.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(moviePresenter.subtitlesAction(_:))))
        ...
        langView.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(moviePresenter.languageAction(_:))))
    ...
    func addTrailerLabel() {
        ...
        trailerLabel?.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(moviePresenter.trailerAction)))
    ...
    func addPurchaseLabel() {
        ...
        purchaseLabel?.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(moviePresenter.purchaseAction)))
    ...
    func addSeasonsView() {
        ...
        currentSeasonLabel!.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(moviePresenter.seasonSwitchTap)))
        ...
        currentSeasonExpander!.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(moviePresenter.seasonSwitchTap)))
    ...
    func addActorsLabels() {
        ...
        actorsDescribingLabel?.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(moviePresenter.expandabelLabelTap(_:))))
    }
...
extension MovieVC: UICollectionViewDataSource, UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        if collectionView == self.seasonCollectionView {
            return moviePresenter.numberOfSeasonMovies
        } else {
            return moviePresenter.numberOfRecommendations
        }
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if collectionView == self.seasonCollectionView {
            ...
            moviePresenter.configureSeasonCell(cell: cell, forRow: indexPath.row)
            return cell
        } else {
            ...
            moviePresenter.configureRecommendationCell(cell: cell, forRow: indexPath.row)
            return cell
        }
    }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        // load selected movie
        if collectionView == self.seasonCollectionView {
            moviePresenter.didSelectSeasonMovie(forRow: indexPath.row)
        } else {
            moviePresenter.didSelectRecommendedMovie(forRow: indexPath.row)
        }
    }
}
